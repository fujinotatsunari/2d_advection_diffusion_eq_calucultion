...
{
	//3�_���l�ϕ��ɂ��g�U�s�����߂�
	vector<double> xi_gauss = { -sqrt(3.0 / 5.0), 0.0, sqrt(3.0 / 5.0) };//���l�ϕ����U�_xi����
	vector<double> eta_gauss = { -sqrt(3.0 / 5.0), 0.0, sqrt(3.0 / 5.0) };//���l�ϕ����U�_eta����
	vector<double> gauss_W = { 5.0 / 9.0, 8.0 / 9.0, 5.0 / 9.0 };//���l�ϕ��d��
	double n_alpha, n_beta, dndxi_alpha, dndxi_beta, dndeta_alpha, dndeta_beta;//�`��֐��Ƃ��̔���
	double A11, A12, A21, A22;//�]���q�v�f
	double Jacobian;//���R�r�A��
